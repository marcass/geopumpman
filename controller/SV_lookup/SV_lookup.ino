 ...
 * - could gernate lookup table in looop in setup(). Apparently non interger look up table pointer and increment it in a non interger way. Then just use the interger portion to look up the sample
 * - useful links for code:
 *   - https://forum.arduino.cc/index.php?topic=530217.0
 *   - https://www.arduino.cc/en/Tutorial/DueSimpleWaveformGenerator#.Uy3IjmRzboY
 *   - https://forum.arduino.cc/index.php?topic=243006.30
 *   - dead time: https://forum.arduino.cc/index.php?topic=590202.15
 */
